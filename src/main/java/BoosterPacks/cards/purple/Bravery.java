...
public class Bravery extends CustomCard {

    public static final String ID = BoosterPacks.makeID(Bravery.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Bravery.png");
