...
public class Augury extends CustomCard {

    public static final String ID = BoosterPacks.makeID(Augury.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Augury.png");
