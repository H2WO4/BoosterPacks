...
public class Valor extends CustomCard {

    public static final String ID = BoosterPacks.makeID(Valor.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Valor.png");
