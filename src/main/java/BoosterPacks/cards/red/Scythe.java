...
public class Scythe extends CustomCard {

    public static final String ID = BoosterPacks.makeID(Scythe.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Scythe.png");
