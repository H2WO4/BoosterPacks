...
import BoosterPacks.actions.silent.SwissKnifeAction;
...
public class SwissKnife extends CustomCard {
    ...
    private int cardDamage() {
        return (AbstractDungeon.player.hand.size() - 1) * this.magicNumber;
    }
