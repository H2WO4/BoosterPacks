...
public class OraclePower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = BoosterPacks.makeID("OraclePower");
    ...
    public AbstractPower makeCopy() {
        return new OraclePower(owner, amount);
    }
}
