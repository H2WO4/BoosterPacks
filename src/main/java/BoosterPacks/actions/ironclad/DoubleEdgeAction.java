...
public class DoubleEdgeAction extends AbstractGameAction {
    ...
    public DoubleEdgeAction(AbstractCreature target, DamageInfo info) {
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    this.addToTop(new ApplyPowerAction(this.source, this.source, new VigorPower(this.source, this.target.lastDamageTaken), this.target.lastDamageTaken));
